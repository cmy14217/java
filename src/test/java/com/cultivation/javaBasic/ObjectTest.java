...
class ObjectTest {
    ...
    void should_get_initialization_ordering() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String[] expected = {"Field Initializer", "Initialization Block3", "Initialization Block", "Initialization Block2", "Constructor with argument", "Default constructor"};
        // --end-->
